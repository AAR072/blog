...
The implications were immediate: any authenticated user who clicks a link to this URL will silently change their account email to whatever the `newEmail` parameter says. And because this is a GET request, the browser sends the session cookie automatically, and no cross-origin restrictions apply.
...
CVSS v3.1: **9.0 (Critical)**. Vector: `AV:N/AC:L/PR:L/UI:R/S:C/C:H/I:H/A:H`
